...
using Vanta.Comm.Device.Melsec.DataTypes;
using Vanta.Comm.Device.Melsec.Runtime;

namespace Vanta.Comm.Device.Melsec
{
    public sealed class MelsecDeviceDriver : IDeviceDriver
    {
        ...
        public string DriverKey
        {
            get
            {
                return MelsecDriverKeys.Melsec;
            }
        }
