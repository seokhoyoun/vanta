...
{
    public sealed class MxComponentDeviceDriver : IDeviceDriver
    {
        public string DriverKey => MxComponentDriverKeys.MxComponent;
        ...
        {
            return new NotSupportedException("MxComponent driver is scaffolded but not implemented yet.");
        }
    }
}
