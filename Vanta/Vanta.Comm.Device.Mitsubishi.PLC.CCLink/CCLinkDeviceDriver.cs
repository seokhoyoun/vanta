...
{
    public sealed class CCLinkDeviceDriver : IDeviceDriver
    {
        public string DriverKey => CCLinkDriverKeys.CCLink;
        ...
        {
            return new NotSupportedException("CC-Link driver is scaffolded but not implemented yet.");
        }
    }
}
